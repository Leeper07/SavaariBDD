...
public class loginPageUI extends driverConfig{
	...
	public void siteNavigation() throws IOException {
	...
	public void agentLogin(ExtentTest logger1) throws InterruptedException {
		this.logger=logger1;
	...
	public void customerLogin(ExtentTest logger1) throws InterruptedException {
		this.logger=logger1;
		lpo=new loginPageObjects(driver);
	...
	public void forgotPassword(ExtentTest logger1) throws InterruptedException {
		this.logger=logger1;
		lpo=new loginPageObjects(driver);
		lpo.signInButton().click();
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
